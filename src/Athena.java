...
public class Athena
{
    public static void main(String[] args) throws IOException
    {
        ...
        else if (service.equalsIgnoreCase("B"))
        {
                ...
                while (inFile4.hasNext())
                {
                    ...
                    if (token2.indexOf("Games:") > -1)
                    {
                        while (inFile4.hasNextLine())
                        {
                            ...
                            if (lineReader.equals("*")){whiteGames1++;}
            ...
            //find the index of the white game coordinate in the 'Games' line for the name.txt doc and add 1
            else
            {
                whoBlack = name;
            ...
            if(ifTime.equalsIgnoreCase("yes") || ifTime.equalsIgnoreCase("y"))
            {
                ...
                while(moves.get(moves.size() -1).indexOf("#") == -1)
                {
                    ...
                    if (moveNum == 1)
                    {
                        ...
                        if(matrixRows == 0){theGameOpening = "Unable to identify opening.";}
                    }
                    ...
                    {    
                        ...
                        for (int h = 0; h < z.length; h++){openingsMatrix[h] = z[h];}
